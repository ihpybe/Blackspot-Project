	...
	<nav class="main-menu">
		...
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
					<a class="subnav-text" href="CityWise2.jsp">
					City Wise
					</a>
					</li>
		...
		<div class="main-grid">
			<div class="agile-grids">	
				...
				<div class="table-heading">
					<h2>BLACK SPOT DETECTION</h2>
				</div>
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h3>View All Spots</h3>
					    <table id="table">
						<thead>
						  <tr>
...
try
{
	PreparedStatement ps= conn.prepareStatement("select * from blackspots where City=?  ");
	ps.setString(1,id);
