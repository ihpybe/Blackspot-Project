...
try
{
	PreparedStatement ps= conn.prepareStatement("select * from policestation ");
...
<tr>
	...
	<td><%=rs1.getString("pass") %>	</td> 
	  ...
	  <td><a href="deleteStation.jsp?id=<%=rs1.getString("StationName")%>">Delete</a></td>
	</tr>
	<%
	}
}
